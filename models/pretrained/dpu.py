...
class DPUNet(torch.nn.Module):
    def __init__(self, stage, bands = 28, size = 256, pretrained_model_path = False):
    ...
    def forward(self, g, input_mask=None):
        ...
        for i in range(self.stage):
            ...
            f = z - r - y / mu + self.mul_PhiTg(Phi_shift, torch.div(g.unsqueeze(1) - Phi_f, mu + PhiPhiT.unsqueeze(1)))
