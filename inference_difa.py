...
def main():
    ...
    resshift_sampler.inference(args.in_path, args.out_path, bs=1, noise_repeat=False, one_step=True, model=model, pretrained_model=args.pretrained_model, dataset=args.dataset, device=device)
